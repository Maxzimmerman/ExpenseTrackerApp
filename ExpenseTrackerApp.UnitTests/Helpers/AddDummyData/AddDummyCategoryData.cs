...
public static class AddDummyCategoryData
{
    ...
    public static (
        ...
        List<CategoryType>, 
        List<CategoryIcon>, 
        List<CategoryColor>) AddCategoriesWithAllRelationsNoExpensesNorIncomes(ApplicationDbContext context)
    {
        var user = new ApplicationUser()
        {
            ApplicationUserName = "User1", 
        ...
        var categoryTypes = new List<CategoryType>()
        {
            new CategoryType() { Name = "Type1" },
            new CategoryType() { Name = "Type2" },
        };
