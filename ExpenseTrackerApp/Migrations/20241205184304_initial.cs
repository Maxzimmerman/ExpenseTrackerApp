        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    LockoutEnd = table.Column<DateTimeOffset>(type: "timestamptz with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CopryRightHolder = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "timestamptz with time zone", nullable: false),
                    IconBackground = table.Column<string>(type: "text", nullable: false),
                    IconType = table.Column<string>(type: "text", nullable: false),
                    ControllerLink = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryIconId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FooterId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
